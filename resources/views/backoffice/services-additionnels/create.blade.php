    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                <x-ui.button type="submit" form="create-service-form">
                    Enregistrer
                </x-ui.button>
            </div>
        </div>

        <form id="create-service-form" action="{{ route('services-additionnels.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            @csrf
